    ...
    def get_train_config(cls) -> TrainConfig:
        if cls.train_config is None:
            ...
            if ConfigName.train_config_name in cls.yaml_config:
                cls.init_config_object_attr(cls.train_config, cls.yaml_config[ConfigName.train_config_name]) # update the config object with the yaml config file training part
